...
class AutoGen():
    def __init__(self, mj_model: mujoco.MjModel):
        ...
        r = Runfiles.Create()
        with open(r.Rlocation("osc-floating-base/config/walter_sr/walter_sr_config.yaml"), "r") as file:
...
def main(argv):
    ...
    mj_model = mujoco.MjModel.from_xml_path(
        r.Rlocation(
            path="mujoco-models/models/walter_sr/WaLTER_Senior_updated_air.xml",
        )
    )
